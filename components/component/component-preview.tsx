...
export function ComponentPreview({
  ...
  return (
    <div className="my-6 flex w-full flex-col">
      <div
        className={cn(
          "relative flex min-h-[250px] w-full items-center justify-center overflow-hidden rounded-t-xl border bg-background p-10",
          "dark:border-zinc-800 dark:bg-[#09090b]"
        )}
      >
        <div className="absolute inset-0 -z-10 h-full w-full bg-[radial-gradient(#27272a_1px,transparent_1px)] bg-size-[16px_16px] opacity-40" />

        <button
          onClick={handleReset}
          className={cn(
            "absolute top-4 right-4 z-10 flex h-7 w-7 items-center justify-center rounded-md  border text-zinc-500 transition-colors",
